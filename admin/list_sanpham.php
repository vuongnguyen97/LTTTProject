		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<table class="table table-hover">
				...
				//Xác định vị trí bắt đầu start
					...
					else
					{
						...
						$query_pg="SELECT COUNT(id) FROM sanpham";
					...
					$query="SELECT * FROM sanpham ORDER BY id LIMIT {$start},{$limit}";
					...
					?>
						<tr>
							...
							<td><?php echo $slide1['tensp']; ?></td>
							<td><img src="../<?php echo $slide1['anh']; ?>" width="30px" height="auto" ></td>
							<td><?php echo $slide1['noidung']; ?></td>
							<td><?php echo $slide1['link']; ?></td>
							<td><?php echo $slide1['gia']; ?></td>
							<td><?php echo $slide1['ordernumb']; ?></td>
							<td>
							...
							<td>
								<a href="edit_sanpham.php?pid=<?php echo $slide1['id']; ?>">
									<img src="../images/edit.png" width="16">
								</a>
							</td>	
							<td>
								<a onclick="return confirm('Bạn thực sự muốn xóa không');" 
								   href="delete_sanpham.php?id=<?php echo $slide1['id']; ?>">
			...
			echo "<ul class='pagination'>";
				if($per_page>1)
				{
					...
					if($current_page!=1)
					{
						echo "<li><a href='list_sanpham.php?s=".($start - $limit)."&p={$per_page}'>Quay lại</a></li>";
					}
					...
					{
						echo "<li><a href='list_sanpham.php?s=".($start + $limit)."&p={$per_page}'>Tiếp theo</a></li>";
					}
				}
			echo "</ul>";
		?>
